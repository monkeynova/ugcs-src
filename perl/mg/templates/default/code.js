...
var i = 0;
BEGIN_LOOP
images[i++] = { file : "$_{file}", thumb_height : $_{thumb_height}, thumb_width : $_{thumb_width}, thumbfile : "$_{thumbfile}", largefile : "$_{largefile}" };
END_LOOP
...
function updateslideshowbar()
{
  ...
  {
    preload = new Image();
    preload.src = images[(curImage + 1) % nimages].largefile;
  }
